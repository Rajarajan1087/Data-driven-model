/*Test Scenario 		: PEGA - NAD (MyDesk_C1_004)
...
public class MyDesk_C1_004 extends SeleniumSetup implements Constants,Generic {
	 ...
	 * @throws Exception
	 */
	@DataProvider(name = "MyDesk_C1_004")
	// Data Provider name
	public Object[][] DATA() throws Exception {
		return DataProviderExcelReader.getExcelData(LoadEnvironment.WB_NAD,LoadEnvironment.Sheet_TestCases_Customer180,"MyDesk_C1_004"); // Get data object
	}
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "SalesRegression" }, dataProvider = "MyDesk_C1_004")
	public void MyDesk_C1_004_Method(String SCRIPT_ID, String ROW)
			throws Exception {
		/************************** Objects Declaration **********************************/
...
//				SP.verify_the_Elements_in_Phone_Number_Summary(PhoneNumberSummary.Phone_Number,PhoneNumberSummary.Account_Number,PhoneNumberSummary.Package_Name,PhoneNumberSummary.Status,PhoneNumberSummary.Installation_Address);
