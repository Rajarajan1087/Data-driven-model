/*Test Scenario 		: PEGA - NAD (MyDesk_CS_010)
...
public class MyDesk_CS_010 extends SeleniumSetup implements Constants,Generic,PEGAConstants {
	 ...
	 * @throws Exception
	 */
	@DataProvider(name = "MyDesk_CS_010")
	// Data Provider name
	public Object[][] DATA() throws Exception {
		return DataProviderExcelReader.getExcelData(LoadEnvironment.WB_NAD,LoadEnvironment.Sheet_TestCases_CustomerSearch,"MyDesk_CS_010"); // Get data object
	}
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "SalesRegression" }, dataProvider = "MyDesk_CS_010")
	public void MyDesk_CS_010_Method(String SCRIPT_ID, String ROW)
			throws Exception {
		/************************** Objects Declaration **********************************/
...
//		Map<String,String> dbmap=DBU.RetrieveCustomerDetails(CLI);		
		...
		/*Click Alert Hide*/
		Com.verify_Alert_Exists(CustomerAlert_Bereavement);
		Com.verify_Alert_Exists(CustomerAlert_Accessibility);
		
		
		Com.click_Hide_Alert_Message();
		
		Com.verify_Alert_NotExists(CustomerAlert_Bereavement);
		Com.verify_Alert_NotExists(CustomerAlert_Accessibility);
