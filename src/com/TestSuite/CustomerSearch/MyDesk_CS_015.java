...
public class MyDesk_CS_015 extends SeleniumSetup implements Constants,Generic {
	 ...
	 * @throws Exception
	 */
	@DataProvider(name = "MyDesk_CS_015")
	// Data Provider name
	public Object[][] DATA() throws Exception {
		return DataProviderExcelReader.getExcelData(LoadEnvironment.WB_NAD,LoadEnvironment.Sheet_TestCases_CustomerSearch,"MyDesk_CS_015"); // Get data object
	}
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "SalesRegression" }, dataProvider = "MyDesk_CS_015")
	public void MyDesk_CS_015_Method(String SCRIPT_ID, String ROW)
			throws Exception {
		/************************** Objects Declaration **********************************/
		...
		/***************************** START OF MAIN TEST ****************************/
				...
				Com.verify_Required_OuterFrame_Present("Telephone Password", false);
