/*Test Scenario 		: PEGA - NAD (MyDesk_CS_022)
...
public class MyDesk_CS_022 extends SeleniumSetup implements Constants,Generic,PEGAConstants {
	 ...
	 * @throws Exception
	 */
	@DataProvider(name = "MyDesk_CS_022")
	// Data Provider name
	public Object[][] DATA() throws Exception {
		return DataProviderExcelReader.getExcelData(LoadEnvironment.WB_NAD,LoadEnvironment.Sheet_TestCases_CustomerSearch,"MyDesk_CS_022"); // Get data object
	}
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "SalesRegression" }, dataProvider = "MyDesk_CS_022")
	public void MyDesk_CS_022_Method(String SCRIPT_ID, String ROW)
			throws Exception {
		/************************** Objects Declaration **********************************/
		...
		String Package=DATA_MAP.get("STATUS");
...
//		Map<String,String> dbmap=DBU.RetrieveCustomerDetails(CLI);		
		...
		Com.verify_the_Elements_in_Customer_Information_Bar(CustomerInformationBar.Caller_Name,CustomerInformationBar.IDandV_Status,CustomerInformationBar.Call_Reason,CustomerInformationBar.Phone_Number,CustomerInformationBar.Package,CustomerInformationBar.Account_Number,CustomerInformationBar.Monthly_Spend,CustomerInformationBar.Total_Call_Length,CustomerInformationBar.My_Call_Length,CustomerInformationBar.Total_Transfers,CustomerInformationBar.Hold_Time);
		Com.verify_Alert_Exists(CustomerAlert_Deceased_Suspected);
		Com.verify_Alert_Exists(CustomerAlert_Collection);
		Com.click_Hide_Alert_Message();
		Com.verify_Alert_NotExists(CustomerAlert_Deceased_Suspected);
		Com.verify_Alert_NotExists(CustomerAlert_Collection);
...
//		Package=SP.getCLI_In_Phone_Summary_Swichpackage(3);
//		
//
//		
