...
//		
//		System.out.println("Str_CLI is" + Str_CLI);
//		System.out.println("Str_Account is" + Str_Account);
		
		Str_CLI="01903783284";
		Map<String,String> dbmap=DBU.RetrieveMobileDetails(Str_CLI);
		
		String MCLI=dbmap.get("MOBILENUMBER");
		String Account=dbmap.get("MOBILEACCOUNTID");
		...
		if((MCLI.equalsIgnoreCase(""))){
			...
			System.out.println("MobAccountID is" + Account);
			 ...
			 MCLI = SGO.ManageMobileSubscription_SGO(Str_CLI,Account);
