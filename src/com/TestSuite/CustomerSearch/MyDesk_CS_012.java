/*Test Scenario 		: PEGA - NAD (MyDesk_CS_012)
...
public class MyDesk_CS_012 extends SeleniumSetup implements Constants,Generic {
	 ...
	 * @throws Exception
	 */
	@DataProvider(name = "MyDesk_CS_012")
	// Data Provider name
	public Object[][] DATA() throws Exception {
		return DataProviderExcelReader.getExcelData(LoadEnvironment.WB_NAD,LoadEnvironment.Sheet_TestCases_CustomerSearch,"MyDesk_CS_012"); // Get data object
	}
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "SalesRegression" }, dataProvider = "MyDesk_CS_012")
	public void MyDesk_CS_012_Method(String SCRIPT_ID, String ROW)
			throws Exception {
		/************************** Objects Declaration **********************************/
...
//		Map<String,String> dbmap=DBU.RetrieveCustomerDetails(CLI);		
		...
		Com.wait_for_Exit_Interaction_Page_To_Load();
