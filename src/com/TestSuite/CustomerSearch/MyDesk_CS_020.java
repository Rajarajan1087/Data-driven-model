/*Test Scenario 		: PEGA - NAD (MyDesk_CS_020)
...
public class MyDesk_CS_020 extends SeleniumSetup implements Constants,Generic {
	 ...
	 * @throws Exception
	 */
	@DataProvider(name = "MyDesk_CS_020")
	// Data Provider name
	public Object[][] DATA() throws Exception {
		return DataProviderExcelReader.getExcelData(LoadEnvironment.WB_NAD,LoadEnvironment.Sheet_TestCases_CustomerSearch,"MyDesk_CS_020"); // Get data object
	}
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "SalesRegression" }, dataProvider = "MyDesk_CS_020")
	public void MyDesk_CS_020_Method(String SCRIPT_ID, String ROW)
			throws Exception {
		/************************** Objects Declaration **********************************/
...
//		Map<String,String> dbmap=DBU.RetrieveCustomerDetails(CLI);		
		...
		VP.select_Bypass_Reason("Internal Call");
		VP.select_Bypass_Subreason("Call From Other Site - Confirmed DPA Completed");
		Thread.sleep(2000);
