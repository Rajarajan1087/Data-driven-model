...
public class MyDesk_C1_002 extends SeleniumSetup implements Constants,Generic {
	...
	public Object[][] DATA() throws Exception {
		return DataProviderExcelReader.getExcelData(LoadEnvironment.WB_NAD,LoadEnvironment.Sheet_TestCases_Customer180,"MyDesk_C1_002"); // Get data object
	}
	...
	public void MyDesk_C1_002_Method(String SCRIPT_ID, String ROW)
		...
		System.out.println("CLI : "+CLI+" Account"+ACCOUNT);
		String Str_CLI= "";
		String Str_Account = "";
		/*************************************** Data Preparation ******************************************/
