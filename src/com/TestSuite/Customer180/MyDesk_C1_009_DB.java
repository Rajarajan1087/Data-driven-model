...
public class MyDesk_C1_009_DB extends SeleniumSetup
implements Constants,Generic,PEGAConstants {
	 ...
	 * @throws Exception
	 */
	@DataProvider(name = "MyDesk_C1_009_DB")
// 	Data Provider name
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "SalesRegression" }, dataProvider = "MyDesk_C1_009_DB")
	public void MyDesk_C1_009_DB_Method(String SCRIPT_ID, String ROW)
			throws Exception {
		/************************** Objects Declaration **********************************/
...
//				Verify Caller Page
				...
				VP.verify_the_caller_Identification_type("Account Holder,Non-Account Holder");
...
//				POR
//				VP.verify_the_password_displayed_for_Telephone_Password("N/A");
...
//				MCY
//				VP.select_the_Additional_Questions_answered_correctly("Can you confirm your house number & postcode?-Apartment 1 Ladywood Court, 188a Lichfield Road, SUTTON COLDFIELD, B74 2TX");
//				VP.select_the_Additional_Questions_answered_correctly("How do we send the bills to you each month?-EMAIL");
				
				
//				EVE
//				VP.verify_the_password_displayed_for_Telephone_Password("ramble01");
//				VP.verify_the_answers_displayed_for_Additional_Questions_Answers("Can you confirm your house number & postcode?-1 DURHAM GARDENS, CHICHESTER, PO19 5DR");
//				VP.verify_the_answers_displayed_for_Additional_Questions_Answers("How do we send the bills to you each month?-EMAIL");
//				VP.verify_the_answers_displayed_for_Additional_Questions_Answers("What is your mobile number on the account?-07815582634");
//				VP.verify_the_answers_displayed_for_Additional_Questions_Answers("What is the email address you have registered with us?-theja36851@nowhere.com");
//				VP.verify_the_answers_displayed_for_Additional_Questions_Answers("What are the last 4 digits of your bank account registered for direct debit with TalkTalk?-0004");
//				VP.select_the_Additional_Questions_answered_correctly("Can you confirm your house number & postcode?-1 DURHAM GARDENS, CHICHESTER, PO19 5DR");
//				VP.select_the_Additional_Questions_answered_correctly("How do we send the bills to you each month?-EMAIL");
				
				VP.verify_the_password_displayed_for_Telephone_Password(dbmap.get("SECURITYANSWERTEXT"));
...
//				Code been changed Void since the related part been removed
...
//				
				...
				CuP.validate_the_Account_Status_in_Customer_Account_Summary_of_Customer_Tab(dbmap.get("PSPSTATUSCODE"));
...
//				CuP.validate_the_Telephone_Home_in_Contact_Details_of_Customer_Tab("01142888053");
...
//				CuP.validate_the_Telephone_Mobile_in_Contact_Details_of_Customer_Tab("N/A");
				...
				//Security Section
//				CuP.validate_the_Password_of_Security_in_Customer_Tab(dbmap.get("SECURITYANSWERTEXT"));
...
//				AP.validate_for_In_Collections_in_Account_Tab("YES");
...
//				AP.validate_the_Brand_of_Account_Summary_in_Account_Tab(dbmap.get("BRAND_NAME").toUpperCase());
//				AP.validate_the_Branch_of_Account_Summary_in_Account_Tab(dbmap.get("BRANCHCODE"));			
...
//				Com.switchToFrame(iframes.defaultcontent);
//				VP.verify_the_CIB_PhoneNumber(CLI);
////				VP.verify_the_CIB_Package_name("Talk Global Anytime");
//				VP.verify_the_CIB_Package_name(dbmap_Switch1.get("NAME"));
