/*Test Scenario 		: PEGA - NAD (MyDesk_C1_003)
...
public class MyDesk_C1_003 extends SeleniumSetup implements Constants,Generic {
	 ...
	 * @throws Exception
	 */
	@DataProvider(name = "MyDesk_C1_003")
	// Data Provider name
	public Object[][] DATA() throws Exception {
		return DataProviderExcelReader.getExcelData(LoadEnvironment.WB_NAD,LoadEnvironment.Sheet_TestCases_Customer180,"MyDesk_C1_003"); // Get data object
	}
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "SalesRegression" }, dataProvider = "MyDesk_C1_003")
	public void MyDesk_C1_003_Method(String SCRIPT_ID, String ROW)
			throws Exception {
		/************************** Objects Declaration **********************************/
		...
		/***************************** START OF MAIN TEST ****************************/
				...
				Com.switchToFrame(iframes.search);
				SP.validate_Switch_package_Link_Enabled(false);
