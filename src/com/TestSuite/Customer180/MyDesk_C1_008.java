/*Test Scenario 		: PEGA - NAD (MyDesk_C1_008)
...
public class MyDesk_C1_008 extends SeleniumSetup implements Constants,Generic {
	 ...
	 * @throws Exception
	 */
	@DataProvider(name = "MyDesk_C1_008")
	// Data Provider name
	public Object[][] DATA() throws Exception {
		return DataProviderExcelReader.getExcelData(LoadEnvironment.WB_NAD,LoadEnvironment.Sheet_TestCases_Customer180,"MyDesk_C1_008"); // Get data object
	}
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "SalesRegression" }, dataProvider = "MyDesk_C1_008")
	public void MyDesk_C1_008_Method(String SCRIPT_ID, String ROW)
			throws Exception {
		/************************** Objects Declaration **********************************/
		...
		/***************************** START OF MAIN TEST ****************************/
				...
				//ContractSummary
				SP.validate_the_Contract_End_Date_in_Summary_Tab("16-Oct-2013");
				SP.validate_the_Remaining_Contract_Term_in_Summary_Tab("0");
				
				
				//Billing Summary
				SP.validate_the_Last_Bill_Date_in_Summary_Tab("11-Dec-2014");
				SP.validate_the_Last_Bill_Amount_in_Summary_Tab("£32.97");
				SP.validate_the_Payment_Due_Date_in_Summary_Tab("19-Dec-2014");
				SP.validate_the_Outstanding_Balance_in_Summary_Tab("£0.00");
				SP.validate_the_Unbilled_Usage_in_Summary_Tab("£0.45");
				SP.validate_the_Next_Bill_Date_in_Summary_Tab("11-Nov-2016");
