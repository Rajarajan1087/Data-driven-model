...
public class MyDesk_C1_018 extends SeleniumSetup implements Constants,Generic,PEGAConstants {
	...
	public Object[][] DATA() throws Exception {
		return DataProviderExcelReader.getExcelData(LoadEnvironment.WB_NAD,LoadEnvironment.Sheet_TestCases_Customer180,"MyDesk_C1_018"); // Get data object
	}
...
//		Str_Account="1008480917";
		...
		if(PreferredContactMethod.equalsIgnoreCase("null")){
