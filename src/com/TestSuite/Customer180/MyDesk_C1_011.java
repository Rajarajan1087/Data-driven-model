/*Test Scenario 		: PEGA - NAD (MyDesk_C1_011)
...
public class MyDesk_C1_011 extends SeleniumSetup implements Constants,Generic {
	 ...
	 * @throws Exception
	 */
	@DataProvider(name = "MyDesk_C1_011")
	// Data Provider name
	public Object[][] DATA() throws Exception {
		return DataProviderExcelReader.getExcelData(LoadEnvironment.WB_NAD,LoadEnvironment.Sheet_TestCases_Customer180,"MyDesk_C1_011"); // Get data object
	}
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "SalesRegression" }, dataProvider = "MyDesk_C1_011")
	public void MyDesk_C1_011_Method(String SCRIPT_ID, String ROW)
			throws Exception {
		/************************** Objects Declaration **********************************/
		...
		/***************************** START OF MAIN TEST ****************************/
				...
				Com.wait_for_Wrap_Page_To_Load("Finalize the Interaction");
				Com.select_an_action_to_perform("Cancel this work");
				Com.wait_for_Wrap_Page_To_Load("Cancel this work");
				Com.select_an_action_to_perform("Finalize the Interaction");
