/*Test Scenario 		: PEGA - NAD (MyDesk_C1_005)
...
public class MyDesk_C1_005 extends SeleniumSetup implements Constants,Generic {
	 ...
	 * @throws Exception
	 */
	@DataProvider(name = "MyDesk_C1_005")
	// Data Provider name
	public Object[][] DATA() throws Exception {
		return DataProviderExcelReader.getExcelData(LoadEnvironment.WB_NAD,LoadEnvironment.Sheet_TestCases_Customer180,"MyDesk_C1_005"); // Get data object
	}
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "SalesRegression" }, dataProvider = "MyDesk_C1_005")
	public void MyDesk_C1_005_Method(String SCRIPT_ID, String ROW)
			throws Exception {
		/************************** Objects Declaration **********************************/
...
//				Case status check
				...
				String[] caseList=CP.verify_Get_Latest_Cases_Details_From_List();
				CP.click_Latest_CaseID_In_List();
				CP.click_CloseButton_Opened_CaseID_In_List();
