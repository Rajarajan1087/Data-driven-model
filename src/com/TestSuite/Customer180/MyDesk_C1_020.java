...
return DataProviderExcelReader.getExcelData(LoadEnvironment.WB_NAD,LoadEnvironment.Sheet_TestCases_Customer180,"MyDesk_C1_020"); // Get data object
}
...
CP.Talksafe_EnrollmentOption_Never("Never","");
Com.click_Submit_Button();
