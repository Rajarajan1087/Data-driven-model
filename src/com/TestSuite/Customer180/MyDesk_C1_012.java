/*Test Scenario 		: PEGA - NAD (MyDesk_C1_012)
...
public class MyDesk_C1_012 extends SeleniumSetup implements Constants,Generic,PEGAConstants {
	 ...
	 * @throws Exception
	 */
	@DataProvider(name = "MyDesk_C1_012")
	// Data Provider name
	public Object[][] DATA() throws Exception {
		return DataProviderExcelReader.getExcelData(LoadEnvironment.WB_NAD,LoadEnvironment.Sheet_TestCases_Customer180,"MyDesk_C1_012"); // Get data object
	}
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "SalesRegression" }, dataProvider = "MyDesk_C1_012")
	public void MyDesk_C1_012_Method(String SCRIPT_ID, String ROW)
			throws Exception {
		/************************** Objects Declaration **********************************/
		...
		/***************************** START OF MAIN TEST ****************************/
				...
				Thread.sleep(2000);
				Com.check_Warning_Alert_While_Case_Opened(OpenCases_SwitchPackage_Warning_Alert);
