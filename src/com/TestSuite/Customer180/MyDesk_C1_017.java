/*Test Scenario 		: PEGA - NAD (MyDesk_C1_017)
...
public class MyDesk_C1_017 extends SeleniumSetup implements Constants,Generic,PEGAConstants {
	 ...
	 * @throws Exception
	 */
	@DataProvider(name = "MyDesk_C1_017")
	// Data Provider name
	public Object[][] DATA() throws Exception {
		return DataProviderExcelReader.getExcelData(LoadEnvironment.WB_NAD,LoadEnvironment.Sheet_TestCases_Customer180,"MyDesk_C1_017"); // Get data object
	}
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "SalesRegression" }, dataProvider = "MyDesk_C1_017")
	public void MyDesk_C1_017_Method(String SCRIPT_ID, String ROW)
			throws Exception {
		/************************** Objects Declaration **********************************/
		...
		/***************************** START OF MAIN TEST ****************************/
				...
				Com.verify_Alert_Exists("Caller has already been verified. Please cancel the case.");
