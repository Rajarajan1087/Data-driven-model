...
public class MyDesk_PayFix_007 extends SeleniumSetup implements Constants,Generic,PEGAConstants {
	 ...
	 * @throws Exception
	 */
	@DataProvider(name = "MyDesk_PayFix_007")
	// Data Provider name
	public Object[][] DATA() throws Exception {
		return DataProviderExcelReader.getExcelData(LoadEnvironment.WB_NAD,LoadEnvironment.Sheet_TestCases_Payments,"MyDesk_PayFix_007"); // Get data object
	}
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "SalesRegression" }, dataProvider = "MyDesk_PayFix_007")
	public void MyDesk_PayFix_007_Method(String SCRIPT_ID, String ROW)
			throws Exception {
		/************************** Objects Declaration **********************************/
