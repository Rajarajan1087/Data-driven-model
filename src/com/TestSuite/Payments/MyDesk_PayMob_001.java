...
public class MyDesk_PayMob_001 extends SeleniumSetup implements Constants,Generic,PEGAConstants {
	 ...
	 * @throws Exception
	 */
	@DataProvider(name = "MyDesk_PayMob_001")
	// Data Provider name
	public Object[][] DATA() throws Exception {
		return DataProviderExcelReader.getExcelData(LoadEnvironment.WB_NAD,LoadEnvironment.Sheet_TestCases_Payments,"MyDesk_PayMob_001"); // Get data object
	}
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "SalesRegression" }, dataProvider = "MyDesk_PayMob_001")
	public void MyDesk_PayMob_001_Method(String SCRIPT_ID, String ROW)
			throws Exception {
		/************************** Objects Declaration **********************************/
...
//				PayMob002
				CP.verify_Payment_Mobile_AccountDetails_Table("Account Number", MOB_ACC);
				CP.verify_Payment_Mobile_AccountDetails_Table("Mobile Number(s)", MOB_CLI);
				
////				EVE
//				CP.verify_Payment_Mobile_AccountDetails_Table("Account Balance", "£0.00");
//				CP.verify_Payment_Mobile_AccountDetails_Table("Latest Bill Amount", "£5.50");
//				CP.verify_Payment_Mobile_AccountDetails_Table("Latest Bill Due Date","14-Feb-2017");
//				CP.verify_Payment_Mobile_AccountDetails_Table("Payment Method", "Recurring Card");
//				
//				
				
//				POR
				CP.verify_Payment_Mobile_AccountDetails_Table("Account Balance", "£128.00");
				CP.verify_Payment_Mobile_AccountDetails_Table("Latest Bill Amount", "£128.00");
				CP.verify_Payment_Mobile_AccountDetails_Table("Latest Bill Due Date","01-Mar-2017");
				CP.verify_Payment_Mobile_AccountDetails_Table("Payment Method", "Recurring Card");
...
//				PayMob003
				...
				CP.validate_the_AccountBalance_Creditcard_Payment(accountbalance);
