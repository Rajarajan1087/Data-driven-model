...
public class MyDesk_PayMob_007 extends SeleniumSetup implements Constants,Generic,PEGAConstants {
	 ...
	 * @throws Exception
	 */
	@DataProvider(name = "MyDesk_PayMob_007")
	// Data Provider name
	public Object[][] DATA() throws Exception {
		return DataProviderExcelReader.getExcelData(LoadEnvironment.WB_NAD,LoadEnvironment.Sheet_TestCases_Payments,"MyDesk_PayMob_007"); // Get data object
	}
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "SalesRegression" }, dataProvider = "MyDesk_PayMob_007")
	public void MyDesk_PayMob_007_Method(String SCRIPT_ID, String ROW)
			throws Exception {
		/************************** Objects Declaration **********************************/
...
//				CP.validate_the_Address_Line_1_of_Billing_Address_in_CardHolder_Address("First Floor Office");
//				CP.validate_the_Town_City_of_Billing_Address_in_CardHolder_Address("LONDON");
//				CP.validate_the_Postcode_of_Billing_Address_in_CardHolder_Address("W11 4AR");
//				POR
				CP.validate_the_Address_Line_1_of_Billing_Address_in_CardHolder_Address("8 ALICE CLOSE");
				CP.validate_the_Town_City_of_Billing_Address_in_CardHolder_Address("HEREFORD");
				CP.validate_the_Postcode_of_Billing_Address_in_CardHolder_Address("HR1 1XQ");
				
				CP.Enter_Higher_Value_AmountToPay_Payment();
				CP.enter_StartDate_Creditcard_Payment("12", "12");
				CP.enter_EndDate_Creditcard_Payment("12", "25");
				
//				PayFix009
				CP.click_Estabilish_Secure_Connection_Button();
				Thread.sleep(1000);
				CP.verify_error_Card_NotSelected_CardDetails_payments();
...
//				PayFix015
				...
				Com.select_An_Action_To_Perform_ForCases("Payment");
...
//				CP.validate_the_Postcode_of_Billing_Address_in_CardHolder_Address("HR1 1XQ");
				...
				CP.verify_StartDate_Creditcard_Payment("12", "12");
				CP.verify_EndDate_Creditcard_Payment("12", "25");
//				EVE
				CP.validate_the_AccountBalance_Creditcard_Payment("1.00");
				
//				POR
//				CP.validate_the_AccountBalance_Creditcard_Payment("1.01");
