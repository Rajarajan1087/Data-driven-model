...
public class MyDesk_PayMob_008 extends SeleniumSetup implements Constants,Generic,PEGAConstants {
	 ...
	 * @throws Exception
	 */
	@DataProvider(name = "MyDesk_PayMob_008")
	// Data Provider name
	public Object[][] DATA() throws Exception {
		return DataProviderExcelReader.getExcelData(LoadEnvironment.WB_NAD,LoadEnvironment.Sheet_TestCases_Payments,"MyDesk_PayMob_008"); // Get data object
	}
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "SalesRegression" }, dataProvider = "MyDesk_PayMob_008")
	public void MyDesk_PayMob_008_Method(String SCRIPT_ID, String ROW)
			throws Exception {
		/************************** Objects Declaration **********************************/
...
//				PayMob019
				...
				CP.click_Payment_Mobile_AccountDetails_Table("Account Number", MOB_ACC);
				

				Thread.sleep(300);
				CP.verify_Payment_Mobile_AccountDetails_Table("Payment Method", "Other");
				Com.verify_Alert_Exists(Warning_OtherPaymentMethod);
