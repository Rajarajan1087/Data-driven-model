...
public class MyDesk_C1_013 extends SeleniumSetup implements Constants,Generic {
	...
	public Object[][] DATA() throws Exception {
		return DataProviderExcelReader.getExcelData(LoadEnvironment.WB_NAD,LoadEnvironment.Sheet_TestCases_BVTPACK,"MyDesk_C1_013"); // Get data object
	}
	...
	public void MyDesk_C1_013_Method(String SCRIPT_ID, String ROW)
		...
		data = dbn.getDataNEW("285",searchByData.blank,"",true,false); // Str_PackageId ,Search by, search value [ NOT_PropID], Contract , Credit class check
		if(data==null){
...
//				//Cases page
				...
				CuP.verify_required_FrameVisibility_Customer_Tab("Security", false);
//				
				//Entering Action
				CP.hover_on_Add_Case_button();
				CP.Verify_Action_Category_for_Cases("TalkSafe");
				CP.Verify_Action_Category_for_Cases("Verify Caller");
				CP.Verify_Action_Category_for_Cases("Payment");
				...
				VP.select_NumberOf_Required_Additional_Question_CheckBox(4);
				Com.click_Submit_Button();
...
//				CP.wait_for_Verify_Cases_Frame_to_load();
//				CP.verify_PageSize_options();
